...
import com.xiaoniuapp.product.service.task.IMsPushAppTask;
 ...
 */
public class MsPushAppTask extends BaseJob {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        before(scheduleJob);
        try {
            IMsPushAppTask msPushAppTask = SpringContextHolder.getBean("msPushAppTask");
            msPushAppTask.pushSms(null);
        } catch (Exception e) {
            error(scheduleJob, e);
        }
        after(scheduleJob);
